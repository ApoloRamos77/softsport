...
BEGIN
    UPDATE representantes SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE categorias SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE grupos SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE becas SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE servicios SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE productos SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE payment_methods SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE seasons SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
...
BEGIN
    ...
    UPDATE games SET fecha_creacion = GETDATE() WHERE fecha_creacion IS NULL;
END
GO
